  ...
  useEffect(() => {
    const fetchProject = async () => {
      const res = await axios.get(
        `https://ssramritapuri.azurewebsites.net/project/${pid}`,
      );
              ...
              <div className="grid grid-cols-1 md:grid-cols-[15rem_1fr] gap-10 py-5">
                  ...
                  <div className="w-full flex flex-col items-start">
                      ...
                      <div className="flex flex-wrap gap-2">
                          ...
                          <a
                              href={`https://ssramritapuri.blob.core.windows.net/data/ppt/${pid}.pptx`}
                              target="_blank"
                              className="text-sm text-white text-center px-2 py-2 bg-[#af0c3e]/100 rounded shadow hover:shadow-lg transition-all duration-300 ease-linear"
                          >
                          ...
                          <a
                              href={`https://ssramritapuri.blob.core.windows.net/data/reports/${pid}.pdf`}
                              target="_blank"
                              className="text-sm text-white text-center px-2 py-2 bg-[#af0c3e]/100 rounded shadow hover:shadow-lg transition-all duration-300 ease-linear"
                          >
                              Project Report
